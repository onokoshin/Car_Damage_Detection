...
model_name = 'VGG16_bumper_damage_model_epo50_step5_batch30_lr0.0001.h5'

### provide the directory path to the model you want to evaluate
model_dir = r"C:\Users\koshin.ono\Avanade\AI Incubator - FNOL\Image_Classificaction\custom_models"

model_path = join(model_dir, model_name)

### provie the directory path to where all the testing images are located
img_folder_dir = r"C:\Users\koshin.ono\Avanade\AI Incubator - FNOL\Image_Classificaction\Images"

### provide the directory path to testing.csv file
testing_df = r"C:/Users/koshin.ono/PycharmProjects/data_cleaning/testing_car.csv"
